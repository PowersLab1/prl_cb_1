...
const totalTrials = 210; // Adjust as needed -- this n umber * ITI, max response time, and feeedback display should be less than 20 minutes!
const totalBlocks = 13;   // Total number of reward probability changes -- KEEP IN MIND meanTrialsPerBlock*TotalBlocks needs to = TotalTrials!!!!!
const meanTrialsPerBlock = 15; // Average trials per block
const maxTrialsPerBlock = 30;   // Max number of trials in a block
